...
namespace karto
{
  ...
  /**
   * Represents a vector (x, y) in 2-dimensional real space. 二维实数空间矢量
   */
  template<typename T>
  class Vector2
  {
  ...
  public:
    /**
     * Gets the x-coordinate of this vector2   获取 X 分量
    ...
    /**
     * Sets the x-coordinate of this vector2   设置 X 分量
    ...
    /**
     * Gets the y-coordinate of this vector2  获取 Y 分量
    ...
    /**
     * Sets the y-coordinate of this vector2  设置 Y 分量
    ...
    /**
     * Returns the square of the length of the vector 计算 X^2 + Y^2
    ...
    /**
     * Returns the length of the vector (x and y).  计算矢量的长度
     ...
     * @returns square distance to the given vector 计算两个矢量差
     */
  ...
  public:
    /**
     * In place Vector2 addition. 定义操作符号
     */
    ...
    /**
     * In place Vector2 subtraction. 定义操作符号
     */
    inline void operator -= (const Vector2& rOther)
    {
      m_Values[0] -= rOther.m_Values[0];
     ...
     * @param rStream output stream 输出
  ...
  /**
   * Represents a vector (x, y, z) in 3-dimensional real space. 定义三维矢量
   */
  template<typename T>
  class Vector3
  {
  ...
  public:
     ...
     * @return square of the length of the vector  长度的平方
     */
    inline kt_double SquaredLength() const
    {
     ...
     * @return Length of the vector 长度
     */
    inline kt_double Length() const
    {
      return sqrt(SquaredLength());
     ...
     * @return string representation of this vector 输出操作
     */
    inline std::string ToString() const
    {
  ...
  public:
    ...
    /**
     * Scales the vector by the given scalar 定义操作符号
     * @param scalar
     */
    ...
    /**
     * Write Vector3 onto output stream 输出信息
     * @param rStream output stream
     * @param rVector to write
     */
     ...
     * @param rStream input stream 输入信息
     */
  ...
  /**
   * Defines a Matrix 3 x 3 class. 定义了一个 3*3 矩阵
   */
  class Matrix3
  {
  public:
  ...
  public:
    /**
     * Sets this matrix to identity matrix   设置为单位矩阵
     */
    void SetToIdentity()
    {
  ...
  /**
   * Defines a bounding box in 2-dimensional real space. 在二维实空间中定义了一个范围框
   */
  class BoundingBox2
  {
  public:
  ...
  public:
    /**
     * Get bounding box minimum 得到最小值
     */
    ...
    /**
     * Set bounding box minimum 设置最小值
     */
    ...
    /**
     * Get bounding box maximum 得到最大值
     */
    ...
    /**
     * Set bounding box maximum 设置最大值
     */
    ...
    /**
     * Get the size of the bounding box 得到范围框的大小
     */
    ...
    /**
     * Add vector to bounding box 在范围框中增加一个矢量
     */
    ...
    /**
     * Add other bounding box to bounding box 在范围框中增加一个范围框
     */
    ...
    /**
     * Whether the given point is in the bounds of this box  判断给定的点是否在范围框中
     * @param rPoint
     * @return in bounds?
     */
  ...
  /**
   * Implementation of a Pose2 transform 坐标变换函数
   */
  class Transform
  {
  public:
    /**
     * Constructs a transformation from the origin to the given pose,构建一个变换，从原点到 rPose 的变换
     * @param rPose pose
     */
    ...
    /**
     * Constructs a transformation from the first pose to the second pose 构建一个变换，从rPose1到 rPose2 的变换
  ...
  private:
    /**
     * Sensor offset pose 传感器在机器人坐标系下的位姿
     */
  ...
  public:
    ...
    SensorVector GetAllSensors()
    {
	  ...
	  forEachMe(SensorManagerMap, &m_Sensors)
      {
  ...
  public:
	...
	virtual kt_bool Validate()
    {
		/* 利用最大角度和最小角度以及角度分辨率来更新激光雷达线的数目 m_NumberOfRangeReadings */
      Update();
  ...
  public:
    ...
    static LaserRangeFinder* CreateLaserRangeFinder(LaserRangeFinderType type, const Name& rName)
    {
      ...
      switch (type)
      {
        ...
        case LaserRangeFinder_Leo:
        {
            pLrf = new LaserRangeFinder((rName.GetName() != "") ? rName : Name("User-Defined LaserRangeFinder2"));

            // Sensing range is 80 meters.
            pLrf->m_pMinimumRange->SetValue(1.0);
            pLrf->m_pMaximumRange->SetValue(20.0);


            pLrf->m_pMinimumAngle->SetValue(math::DegreesToRadians(-55.5));
            pLrf->m_pMaximumAngle->SetValue(math::DegreesToRadians(56));

            // 0.5 degree angular resolution
            pLrf->m_pAngularResolution->SetValue(math::DegreesToRadians(0.5));

            // 激光束的数目
            pLrf->m_NumberOfRangeReadings = 224;
          }
          break;
      }
  ...
  typedef enum
  {
    GridStates_Unknown = 0,     /* 位置区域   */
    GridStates_Occupied = 100,  /* 障碍物区域 */
    GridStates_Free = 255,       /* 空白区域   */
    GridStates_SensorPosition = 200 // added by myself
  } GridStates;
  ...
  public:
    ...
    /**
     * Converts the point from world coordinates to grid coordinates 世界坐标转换为网格坐标
  ...
  public:
    /**
     * Creates a grid of given size and resolution 创建一个指定分辨率和指定大小的网格
     * @param width
     * @param height
     * @param resolution
     * @return grid pointer
  ...
  public:
    /**
     * Clear out the grid data 清除网格数据
     */
    void Clear()
    {
    ...
    /**
     * Returns a clone of this grid  克隆一个与本网格相同的网格数据结构
     * @return grid clone
     */
    Grid* Clone()
    {
    ...
    /**
     * Resizes the grid (deletes all old data)   重新定义 grid 
     * @param width
     * @param height
     */
    ...
    /**
     * Checks whether the given coordinates are valid grid indices 检查索引的合法性
     * @param rGrid
     */
    ...
    /**
     * Gets the index into the data pointer of the given grid coordinate  根据给定的网格坐标计算索引值
     * @param rGrid
    ...
    /**
     * Gets the grid coordinate from an index  由索引值转换为坐标
     * @param index
     * @return grid coordinate
     */
    ...
    /**
     * Converts the point from grid coordinates to world coordinates 网格坐标转换为世界坐标
     * @param rGrid world coordinate
     * @param flipY
     * @return world coordinate
     */
    ...
    /**
     * Gets pointer to data at given grid coordinate 获取指定网格坐标的数据指针
    ...
    /**
     * Gets the width of the grid 获取网格的宽度
    ...
    /**
     * Gets the height of the grid  获取网格的高度
    ...
    /**
     * Get the size as a Size2<kt_int32s> 获取网格的大小
    ...
    /**
     * Gets the width step in bytes 获取网格宽度步长，是 8 字节整数倍
     * @return width step
     */
    ...
    /**
     * Gets the grid data pointer  获取网格的数据指针
     * @return data pointer
     */
    ...
    /**
     * Gets const grid data pointer 获取网格的数据指针
     * @return data pointer
     */
    ...
    /**
     * Gets the allocated grid size in bytes  获取网格的数据大小
     * @return data size
     */
    ...
    /**
     * Get value at given grid coordinate 获取指定网格的数据
     * @param rGrid grid coordinate
     * @return value
     */
    ...
    /**
     * Gets the coordinate converter for this grid 获取坐标转换器
    ...
    /**
     * Gets the grids bounding box 获取网格的边界信息
     * @return bounding box
     */
    inline BoundingBox2 GetBoundingBox() const
    {
    ...
    /**
     * Increments all the grid cells from (x0, y0) to (x1, y1);  计算从点 (x0, y0) 到 (x1, y1) 所有坐标点
     * if applicable, apply f to each cell traced  数据保存在 m_pData 中
     * @param x0
     * @param y0
     * @param x1
     * @param y1
  ...
  private:
    kt_int32s m_Width;       // width of grid   宽度和高度
    kt_int32s m_Height;      // height of grid
    kt_int32s m_WidthStep;   // 8 bit aligned width of grid   grid 的大小
    T* m_pData;              // grid data  /* grid 数据指针 */

    // coordinate converter to convert between world coordinates and grid coordinates
    CoordinateConverter* m_pCoordinateConverter; /* 坐标转换函数 */
  };  // Grid
  ...
  /**
   * SensorData is a base class for all sensor data 传感器数据基类
   */
  ...
  public:
    ...
    /**
     * Get the sensor that created this sensor data 创建这个数据的传感器名称
     * @return sensor
     */
  ...
  public:
    ...
    /**
     * Sets the range readings for this scan  设置扫描数据
     * @param rRangeReadings
     */
  ...
  private:
    kt_double* m_pRangeReadings; // 一次扫描的到的所有数据点
    kt_int32u m_NumberOfRangeReadings; // 一次扫描的到的所有数据点个数
  };  // LaserRangeScan
  ...
  public:
     ...
     */
    /* 使用雷达名称和扫描数据构建一个 LocalizedRangeScan 类 */
  ...
  public:
    ...
    /**
     * Computes the robot pose given the corrected scan pose 给定校准的扫描线姿势计算机器人姿势
     * @param rScanPose pose of the sensor
     * rScanPose是传感器在世界坐标系中的位置
     */
    ...
    /**
     * Computes the position of the sensor if the robot were at the given pose   给定机器人姿势计算雷达的姿势，在世界坐标系中
     * @param rPose
     * @return sensor pose
     */ 
    ...
    /**
     * Gets the bounding box of this scan   得到扫描线的范围框
    ...
    /**
     * Get point readings in local coordinates 应该是得到世界坐标系中的点坐标，在Update()里已经转变成世界坐标系了
     */
  ...
  private:
     ...
     */
    /* 基于 range reading 计算点的位置坐标, 在世界坐标系中的坐标 */
	virtual void Update()
    {
      ...
      if (pLaserRangeFinder != NULL)
      {
        ...
        for (kt_int32u i = 0; i < pLaserRangeFinder->GetNumberOfRangeReadings(); i++, beamNum++)
        {
          ...
          if (!math::InRange(rangeReading, pLaserRangeFinder->GetMinimumRange(), rangeThreshold))
          {
			...
			// kt_double angle = scanPose.GetHeading() + maximumAngle - beamNum * angularResolution;
        ...
        // compute barycenter 计算扫描点的质心,就是把所有的扫描点位置加起来进行求平均
        ...
        // calculate bounding box of scan m_BoundingBox 这个框将所有的点都包含了进去
        m_BoundingBox = BoundingBox2();
        m_BoundingBox.Add(scanPose.GetPosition());
		forEachMe(PointVectorDouble, &m_PointReadings)
        {
  ...
  private:
    /**
     * Odometric pose of robot 根据里程计得到的机器人在世界坐标系中的位姿
     */
    Pose2 m_OdometricPose;  

    /**
     * Corrected pose of robot calculated by mapper (or localizer) 校准后机器人在世界坐标系中的位姿
     */
    Pose2 m_CorrectedPose;

  protected:
    /**
     * Average of all the point readings 所有扫描点的质心,在世界坐标系中的位姿
     */
    Pose2 m_BarycenterPose;  

    /**
     * Vector of point readings   所有扫描点的位置坐标,在世界坐标系中的位置
     */
    PointVectorDouble m_PointReadings;

    /**
     * Vector of unfiltered point readings   所有扫描点的位置坐标,在世界坐标系中的位置
     */
    PointVectorDouble m_UnfilteredPointReadings;

    /**
     * Bounding box of localized range scan  扫描点的范围框
     */
    BoundingBox2 m_BoundingBox;

    /**
     * Internal flag used to update point readings, barycenter and bounding box  表示是否需要更新点坐标
     */
    kt_bool m_IsDirty; 
  };  // LocalizedRangeScan
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  /**
   * Occupancy grid definition. See GridStates for possible grid values. 占位网格
   */
  ...
  public:
    /**
     * Constructs an occupancy grid of given size  构建一个给定大小的占位地图
     * @param width       宽度
     * @param height      高度
     * @param rOffset     偏移量
    ...
    OccupancyGrid(kt_int32s width, kt_int32s height, const Vector2<kt_double>& rOffset, kt_double resolution)
      ...
      , m_pCellVisitedCnt(Grid<kt_int32u>::CreateGrid(0, 0, resolution)) // added by myself
      , m_pCellUpdater(NULL)
    {
      m_pCellUpdater = new CellUpdater(this);

      if (karto::math::DoubleEqual(resolution, 0.0))  /* 分辨率不能为零 */
      {
    ...
    virtual ~OccupancyGrid()
    {
      ...
      delete m_pCellVisitedCnt; // added by myself
  ...
  public:
    ...
    static OccupancyGrid* CreateFromScans(const LocalizedRangeScanVector& rScans, kt_double resolution)
    {
      ...
      ComputeDimensions(rScans, resolution, width, height, offset); /* 确定地图的大小和偏移量 */
    ...
    OccupancyGrid* Clone() const
    {
      ...
      pOccupancyGrid->m_pCellVisitedCnt = m_pCellVisitedCnt->Clone(); // added by myself

      return pOccupancyGrid;
    }

    /**
     * Check if grid point is free 检查一个网格点是否为空
     * @param rPose
    ...
    /**
     * Casts a ray from the given point (up to the given max range)   项目中这个函数没有使用
     * and returns the distance to the closest obstacle
     * @param rPose2
     * @param maxRange
     * @return distance to closest obstacle
	 功能：按照一定的角度进行光线投影，一直到最大范围 maxRange
     */
  ...
  protected:
    ...
    /**
     * Get cell visited grid, added by myself
     * @return Grid<kt_int32u>*
     */
    virtual Grid<kt_int32u>* GetCellVisitedCounts()
    {
      return m_pCellVisitedCnt;
    }

  protected:
    /**
     * Calculate grid dimensions from localized range scans 从雷达数据计算网格的维数
     * @param rScans
     * @param resolution
     * @param rWidth    地图的宽度
     * @param rHeight   地图的高度
                                  ...
                                  Vector2<kt_double>& rOffset)
    {
      ...
      kt_double scale = 1.0 / resolution;            // 缩放参数
      Size2<kt_double> size = boundingBox.GetSize(); // 实际大小
    ...
    /**
     * Create grid using scans 利用扫描创建网格
     * @param rScans
     */
    virtual void CreateFromScans(const LocalizedRangeScanVector& rScans)
    {
      ...
      // added by myself
      m_pCellVisitedCnt->Resize(GetWidth(), GetHeight());
      m_pCellVisitedCnt->GetCoordinateConverter()->SetOffset(GetCoordinateConverter()->GetOffset());
     ...
     * update the grid's cells' occupancy status) 将扫描线叠加到网格上
     * @param pScan
    ...
    /**
     * Traces a beam from the start position to the end position marking   光线投影
     * the bookkeeping arrays accordingly.
     * @param rWorldFrom start position of beam   激光线的起始点
     * @param rWorldTo end position of beam       激光线的终点
     * @param isEndPointValid is the reading within the range threshold?  是否在阈值范围内
     * @param doUpdate whether to update the cells' occupancy status immediately  是否进行立刻更新
     * @return returns false if an endpoint fell off the grid, otherwise true
     */
                             ...
                             kt_bool doUpdate = false)
    {
      ...
      assert(m_pCellVisitedCnt != NULL); // added by myself
    ...
    /**
     * Updates a single cell's value based on the given counters   根据击中点和非击中点进行地图更新
     * @param pCell
     * @param cellPassCnt
     * @param cellHitCnt
     */
    ...
    /**
     * Update the grid based on the values in m_pCellHitsCnt and m_pCellPassCnt 更新网格地图
     */
    virtual void Update()
    {
      assert(m_pCellPassCnt != NULL && m_pCellHitsCnt != NULL);
      ...
      for (kt_int32u i = 0; i < nBytes; i++, pDataPtr++, pCellPassCntPtr++, pCellHitCntPtr++, /* added by myself */pCellVisitedCntPtr++)
      {
        UpdateCell(pDataPtr, *pCellPassCntPtr, *pCellHitCntPtr);
        // added by myself
        if(*pCellVisitedCntPtr > 0)
        {
            //*(pDataPtr-m_pCellVisitedCnt->GetWidthStep()-1) = GridStates_SensorPosition;
            //*(pDataPtr-m_pCellVisitedCnt->GetWidthStep()) = GridStates_SensorPosition;
            //*(pDataPtr-m_pCellVisitedCnt->GetWidthStep()+1) = GridStates_SensorPosition;
            //*(pDataPtr-1) = GridStates_SensorPosition;
            *pDataPtr = GridStates_SensorPosition;
            //*(pDataPtr+1) = GridStates_SensorPosition;
            //*(pDataPtr+m_pCellVisitedCnt->GetWidthStep()-1) = GridStates_SensorPosition;
            //*(pDataPtr+m_pCellVisitedCnt->GetWidthStep()) = GridStates_SensorPosition;
            //*(pDataPtr+m_pCellVisitedCnt->GetWidthStep()+1) = GridStates_SensorPosition;
    ...
    virtual void Resize(kt_int32s width, kt_int32s height)
    {
      ...
      m_pCellVisitedCnt->Resize(width, height); // added by myself
    }
  ...
  protected:
     ...
     * 记录雷达运行轨迹
     */
    Grid<kt_int32u>* m_pCellVisitedCnt;
  ...
  public:
    /**
     * Adds object to this dataset 向数据集中增加一个对象
     * @param pObject
     */
    void Add(Object* pObject)
    {
      if (pObject != NULL)
      {
        if (dynamic_cast<Sensor*>(pObject))  /* 增加一个扫描设备 */
        {
        ...
        else if (dynamic_cast<SensorData*>(pObject))  /* 增加一个扫描数据 */
        {
    ...
    virtual void Clear()
    {
	  ...
	  forEachMe(ObjectVector, &m_Objects)
      {
        delete *iter;
      }
  ...
  /**
   * An array that can be resized as long as the size 构建一个数组
  ...
  public:
    ...
    /**
     * Sets size of array (resize if not big enough) 重新设置数组的大小
     * @param size
     */
  ...
  public:
    /**
     * Gets the lookup array for a particular angle index, 每个角度索引都有一个表格,根据角度索引得到对应的表格
     * @param index
     * @return lookup array
     */
     ...
     */
    void ComputeOffsets(LocalizedRangeScan* pScan, /* range scan  数据 */
                        kt_double angleCenter,     /* angleCenter 表示初始角度中心   */
                        kt_double angleOffset,     /* angleOffset 表示角度搜索的范围 */
                        kt_double angleResolution) /* angleResolution 表示角度搜索的分辨率 */
    {
      assert(angleOffset != 0.0);
      assert(angleResolution != 0.0);

	  /* 根据角度范围和分辨率计算出需要搜索的角度数目 */
      kt_int32u nAngles = static_cast<kt_int32u>(math::Round(angleOffset * 2.0 / angleResolution) + 1);
      SetSize(nAngles); /* 设置表格的大小 */

      //////////////////////////////////////////////////////
      // convert points into local coordinates of scan pose
	  /* 得到扫描点数据,这时的坐标系为世界坐标系 */
      const PointVectorDouble& rPointReadings = pScan->GetPointReadings();

      // compute transform to scan pose, 定义了一个变换，变换后的坐标系为机器人所在的世界坐标系
      ...
      const_forEach(PointVectorDouble, &rPointReadings)
      {
        ...
        localPoints.push_back(vec); /* 存放的是局部坐标 */
      }

      //////////////////////////////////////////////////////
      // create lookup array for different angles 对每个角度都创建一个表格
      kt_double angle = 0.0;
      kt_double startAngle = angleCenter - angleOffset;   /* 起始角度 */
      for (kt_int32u angleIndex = 0; angleIndex < nAngles; angleIndex++)
      {
        angle = startAngle + angleIndex * angleResolution;
        ComputeOffsets(angleIndex, angle, localPoints, pScan);  /* 针对每个角度计算一个索引值 */
      }
  ...
  private:
    /**
     * Compute lookup value of points for given angle 对每个角度都计算一个偏移值
     * @param angleIndex	角度索引值
     * @param angle			实际的角度信息
     * @param rLocalPoints	扫描点的位置信息,这里的坐标系为局部坐标
	 * @param pScan         激光雷达数据	
     */
    void ComputeOffsets(kt_int32u angleIndex, kt_double angle, const Pose2Vector& rLocalPoints, LocalizedRangeScan* pScan)
    {
      m_ppLookupArray[angleIndex]->SetSize(static_cast<kt_int32u>(rLocalPoints.size())); /* 初始化大小 */
	  ...
	  const_forEach(Pose2Vector, &rLocalPoints)
      {
        ...
        Vector2<kt_double> offset;
        offset.SetX(cosine * rPosition.GetX() - sine * rPosition.GetY()); /* 相当于旋转了 angle 角度 */
        ...
        pAngleIndexPointer[readingIndex] = lookupIndex; /* 计算得到索引值 */
    ...
    void SetSize(kt_int32u size)
    {
      ...
      if (size > m_Capacity)
      {
        ...
        m_Capacity = size;
        m_ppLookupArray = new LookupArray*[m_Capacity]; /* 这是一个二重指针 */
  ...
  private:
    ...
    kt_int32u m_Capacity;
    kt_int32u m_Size; /* 根据角度分辨率计算出的可能表格个数 */
